# -*- coding: utf-8 -*-
"""
Custom keras model in ray 1.12.1.

Initial version obtained from https://github.com/ray-project/ray/blob/master/rllib/examples/custom_keras_model.py
and then modified based on runtime errors and depreciation warnings in 1.12.1
"""
...
from ray.rllib.agents.callbacks import DefaultCallbacks     # replacement of callbacks dict interface
...
class MyKerasCallbacks(DefaultCallbacks) :
    def __init__(self, legacy_callbacks_dict: Dict[str, callable] = None):
        super(MyKerasCallbacks, self).__init__(legacy_callbacks_dict)

    def on_train_result(self, *, trainer, result: dict, **kwargs):
        # Moved the code from "check_has_cusotm_metric" to here
        print(result)
        ...
        assert r["model"]["foo"] == tf.constant(42.0), result
...
if __name__ == "__main__":
    ...
    if args.run == "DQN":
        ...
        # learning_starts parameter no longer a sub-element of replay_buffer_config
    ...
    tune.run(
        ...
        config=dict(
            ...
            **{
                ...
                "callbacks": MyKerasCallbacks,
                # callback definition via dict is depcreated
                # "callbacks" : {
                #     "on_train_result": check_has_custom_metric,  
                # },
                "model": {
                    "custom_model": "keras_q_model" if args.run == "DQN"
                    else "keras_model"
                },
