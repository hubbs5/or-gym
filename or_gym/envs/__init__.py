...
register(
    id="BinPacking-v0", entry_point="or_gym.envs.classic_or.binpacking:BinPackingEnv"
)

register(
    id="BinPacking-v1", entry_point="or_gym.envs.classic_or.binpacking:BinPackingLW1"
)

register(
    id="BinPacking-v2", entry_point="or_gym.envs.classic_or.binpacking:BinPackingPP0"
)

register(
    id="BinPacking-v3", entry_point="or_gym.envs.classic_or.binpacking:BinPackingPP1"
)

register(
    id="BinPacking-v4", entry_point="or_gym.envs.classic_or.binpacking:BinPackingBW0"
)

register(
    id="BinPacking-v5", entry_point="or_gym.envs.classic_or.binpacking:BinPackingBW1"
)

# Newsvendor Envs
register(
    id="Newsvendor-v0", entry_point="or_gym.envs.classic_or.newsvendor:NewsvendorEnv"
)

# Virtual Machine Packing Envs
register(id="VMPacking-v0", entry_point="or_gym.envs.classic_or.vmpacking:VMPackingEnv")

register(
    id="VMPacking-v1", entry_point="or_gym.envs.classic_or.vmpacking:TempVMPackingEnv"
)
...
# TSP
register(id="TSP-v0", entry_point="or_gym.envs.classic_or.tsp:TSPEnv")

register(id="TSP-v1", entry_point="or_gym.envs.classic_or.tsp:TSPDistCost")
